  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-900 via-brand-800 to-brand-700 px-4">
      <div className="w-full max-w-sm rounded-3xl bg-white p-8 shadow-xl">
        ...
        <h1 className="mt-6 text-base font-semibold text-slate-800">QA Brain</h1>
        ...
        >
          <button
            type="submit"
            className="w-full rounded-xl bg-brand-800 px-4 py-2.5 text-[13px] font-semibold text-white transition-colors hover:bg-brand-700"
          >
